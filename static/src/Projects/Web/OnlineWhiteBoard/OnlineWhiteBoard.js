...
Optional: Add feature to invite friends to collaborate on a white board online.
*/
class OnlineWhiteBoard extends Component {
  ...
  render() {
    ...
    <div className="module">
      <div className="title">OnlineWhiteBoard</div>
      <div className="body">
