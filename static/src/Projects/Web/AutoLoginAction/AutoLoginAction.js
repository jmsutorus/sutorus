...
/*
Make an application which logs into a given site on a schedule and invokes a certain action and then logs out.
This can be useful for checking web mail, posting regular content, or getting info for other applications and saving it to your computer.
*/
class AutoLoginAction extends Component {
  ...
  render() {
    ...
    <div className="module">
      <div className="title">AutoLoginAction</div>
      <div className="body">
