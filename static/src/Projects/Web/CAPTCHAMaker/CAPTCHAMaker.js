...
It keeps web bots from automatically signing up and spamming.
Try creating one yourself for online forms.
*/
class CAPTCHAMaker extends Component {
  ...
  render() {
    ...
    <div className="module">
      <div className="title">CAPTCHAMaker</div>
      <div className="body">
