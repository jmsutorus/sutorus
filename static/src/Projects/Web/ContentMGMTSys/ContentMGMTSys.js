...
Optional: Allow for the addition of modules/addons.
*/
class ContentMGMTSys extends Component {
  ...
  render() {
    ...
    <div className="module">
      <div className="title">ContentMGMTSys</div>
      <div className="body">
