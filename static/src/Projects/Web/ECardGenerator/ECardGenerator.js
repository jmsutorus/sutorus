...
/*
Make a site that allows people to generate their own little e-cards and send them to other people
 Do not use Flash. Use a picture library and perhaps insightful mottos or quotes.
*/
class ECardGenerator extends Component {
  ...
  render() {
    ...
    <div className="module">
      <div className="title">ECardGenerator</div>
      <div className="body">
