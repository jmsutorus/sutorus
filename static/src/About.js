    ...
    return (
      <div className="home">
        <div className="home-topbar">
          <div>
            <button className="home-button" onClick={this.routeHome}>
              Joseph Sutorus
            </button>
          </div>
          <div>
        ...
        <div className="home-body">
          ...
          <div className="about-info-wrapper">
            ...
            <div className="info-item">
              Studied Computer Science with a focus in frontend development and
              UX.
            </div>
            <div className="info-item">
              Earned minors in both maths and business.
            </div>
            <div className="info-item">
              Graduated from Texas A&M in 2018 with honors.
            </div>
            <div className="info-item">
              Went to work at H-E-B as a fullstack software developer.
            </div>
            <div className="info-item">
              Quickly promoted and named Project Lead.
            </div>
          </div>
        </div>
      </div>
